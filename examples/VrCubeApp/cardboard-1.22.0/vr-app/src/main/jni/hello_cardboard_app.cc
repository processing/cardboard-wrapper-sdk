...
constexpr float kMinTargetDistance = 3.5f;
constexpr float kMaxTargetDistance = 4.5f;
constexpr float kMinTargetHeight = 1.5f;
...
void HelloCardboardApp::OnSurfaceCreated(JNIEnv* env) {
  ...
  HELLOCARDBOARD_CHECK(
      room_tex_.Initialize(env, java_asset_mgr_, "white.png"));
